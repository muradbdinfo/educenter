  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('public/backend/dist/img/AdminLTELogo.png')}}" alt=" Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
...
<li class="nav-item">
<a href="{{URL::to('/userlist1')}}" class="nav-link">
...
<ul class="nav nav-treeview">
<li class="nav-item">
<a href="{{URL::to('/list_event')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>  List</p>
</a>
</li>
<li class="nav-item">
<a href="{{URL::to('/add_event')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p> Add</p>
</a>
</li>
...
<ul class="nav nav-treeview">
<li class="nav-item">
<a href="{{URL::to('/list_slider')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>  List</p>
</a>
</li>
<li class="nav-item">
<a href="{{URL::to('/add_slider')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p> Add</p>
</a>
</li>
...
<ul class="nav nav-treeview">
<li class="nav-item">
<a href="{{URL::to('/list_post')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p>  List</p>
</a>
</li>
<li class="nav-item">
<a href="{{URL::to('/add_post')}}" class="nav-link">
<i class="far fa-circle nav-icon"></i>
<p> Add</p>
</a>
</li>
