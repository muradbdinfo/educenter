    ...
    <div class="row">
      ...
      <div class="col-md-2">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{URL::to('/insert_notice')}}" method="post" enctype="multipart/form-data">
              	@csrf
                <div class="card-body">
...
<input type="text" name="name"  class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" placeholder="Enter Notice Name">
